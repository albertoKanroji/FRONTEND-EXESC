...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'actividades', data: { breadcrumb: 'actividades' }, loadChildren: () => import('./actividades/actividades.module').then(m => m.ActividadesModule) },
        { path: 'alumnos', data: { breadcrumb: 'alumnos' }, loadChildren: () => import('./alumnos/alumnos.module').then(m => m.AlumnosModule) },
        { path: 'grupos', data: { breadcrumb: 'grupos' }, loadChildren: () => import('./grupos/grupos.module').then(m => m.GruposModule) },
        { path: 'docentes', data: { breadcrumb: 'docentes' }, loadChildren: () => import('./docentes/docentes.module').then(m => m.DocentesModule) },
        { path: 'jefes', data: { breadcrumb: 'jefes' }, loadChildren: () => import('./jefes/jefes.module').then(m => m.JefesModule) },
        { path: 'periodos', data: { breadcrumb: 'periodos' }, loadChildren: () => import('./periodos/periodos.module').then(m => m.PeriodosModule) },
        { path: 'evalucaciones', data: { breadcrumb: 'evalucaciones' }, loadChildren: () => import('./evaluaciones/evaluaciones.module').then(m => m.EvaluacionesModule) },
        { path: 'encuestas', data: { breadcrumb: 'encuestas' }, loadChildren: () => import('./encuestas/encuestas.module').then(m => m.EncuestasModule) },
        { path: 'informes', data: { breadcrumb: 'informes' }, loadChildren: () => import('./informes/informes.module').then(m => m.InformesModule) },
        { path: 'boletas', data: { breadcrumb: 'boletas' }, loadChildren: () => import('./boletas/boletas.module').then(m => m.BoletasModule) },
        { path: 'liberaciones', data: { breadcrumb: 'liberaciones' }, loadChildren: () => import('./liberaciones/liberaciones.module').then(m => m.LiberacionesModule) },
        { path: 'bajas', data: { breadcrumb: 'bajas' }, loadChildren: () => import('./bajas/bajas.module').then(m => m.BajasModule) },
        { path: 'alumno/datos', data: { breadcrumb: 'datos-alumno' }, loadChildren: () => import('./alumnos/alumnos.module').then(m => m.AlumnosModule) },
        { path: 'alumno/encuestas', data: { breadcrumb: 'encuestas-alumno' }, loadChildren: () => import('./horario-student/horario-student.module').then(m => m.HorarioStudentModule) },
        { path: 'alumno/horario', data: { breadcrumb: 'horario-alumno' }, loadChildren: () => import('./encuestas-student/encuestas-student.module').then(m => m.EncuestasStudentModule) },
